...
const ListaProductos = () => {
  ...
  return (
    <div>
      <div>
        <Producto 
          precio={products.filter(p=>p.id==='1u').map(p=>p.precio)}
          nombre={products.filter(p=>p.id==='1u').map(p=>p.nombre)}
          imagen={products.filter(p=>p.id==='1u').map(p=>p.imagen)}/>
      </div>
      <div>
        <Producto
          precio={products.filter(p=>p.id==='2u').map(p=>p.precio)}
          nombre={products.filter(p=>p.id==='2u').map(p=>p.nombre)}
          imagen={products.filter(p=>p.id==='2u').map(p=>p.imagen)}/>
      </div>
      <div>
        <Producto 
          precio={products.filter(p=>p.id==='3u').map(p=>p.precio)}
          nombre={products.filter(p=>p.id==='3u').map(p=>p.nombre)}
          imagen={products.filter(p=>p.id==='3u').map(p=>p.imagen)}/>
      </div>
      <div>
        <Producto
          precio={products.filter(p=>p.id==='4u').map(p=>p.precio)}
          nombre={products.filter(p=>p.id==='4u').map(p=>p.nombre)}
          imagen={products.filter(p=>p.id==='4u').map(p=>p.imagen)}/>
      </div>
